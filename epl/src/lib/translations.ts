export const translations = {
  en: {
    ...
    assetStoreManagement: 'Asset Store Management',
    roleControl: 'Role Control',
    saveChanges: 'Save Changes',
    moderatorMode: 'Moderator Mode',
    adminMode: 'Admin Mode',
    userMode: 'User Mode',
    shopkeeperMode: 'Shopkeeper Mode',
    ...
    play: 'Play',
    permissions: {
      accessRecent: 'Access Recent',
      accessAssetStore: 'Access Asset Store',
      accessPremium: 'Access Premium',
      accessControl: 'Access Control',
      sellInAssetStore: 'Sell in Asset Store',
      publishApps: 'Publish Apps',
  ...
  ru: {
    ...
    help: 'Помощь',
    control: 'Управление',
    appVerification: 'Верификация приложений',
    userManagement: 'Управление пользователями',
    assetStoreManagement: 'Управление магазином ассетов',
    roleControl: 'Управление ролями',
    saveChanges: 'Сохранить изменения',
    moderatorMode: 'Режим модератора',
    adminMode: 'Режим администратора',
    userMode: 'Режим пользователя',
    shopkeeperMode: 'Режим продавца',
    developerMode: 'Режим разработчика',
    simulationActive: 'Симуляция активна',
    featured: 'Популярное',
    recent: 'Новое',
    update: 'Обновить',
    play: 'Играть',
    permissions: {
      accessRecent: 'Доступ к разделу "Новое"',
      accessAssetStore: 'Доступ к магазину ассетов',
      accessPremium: 'Доступ к Премиум',
      accessControl: 'Доступ к Управлению',
      sellInAssetStore: 'Продавать в магазине ассетов',
      publishApps: 'Публиковать приложения',
      premiumFeatures: 'Премиум возможности'
    },
